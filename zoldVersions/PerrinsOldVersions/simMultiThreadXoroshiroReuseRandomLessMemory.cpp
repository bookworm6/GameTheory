...
// Compile: g++ -O3 -std=c++17 simMultiThreadXoroshiroReuseRandomLessMemory.cpp -o simMultiThreadXoroshiroReuseRandomLessMemory -pthread
// Run: ./sim
//
// Outputs CSV files:
...
TorusResult torusTournament(AgentGrid agentGrid, int iters, int rounds, int snaps, float evolutionRate, //could agentGrid be passed by reference?
    ...
    for (int round=0; round<rounds; ++round) {
        ...
        auto worker = [&](int t_id, int startRow, int endRow,int ) {
